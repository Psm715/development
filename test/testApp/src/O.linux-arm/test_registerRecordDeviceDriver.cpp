...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devtestVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLoSoftCallback", "devLsiSoft", "devLsiEnviron", "devtestVersion",
...
int test_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/pi/epics/test";
...
{
    iocshSetError(test_registerRecordDeviceDriver(*iocshPpdbbase));
}

...
/* Generated from ../O.Common/pm.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "stringin", "stringout", "sub", "subArray", "waveform", "xxx"
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devpmVersion, *pvar_dset_devLsoSoft,
    ...
    *pvar_dset_devWfPDBDemo, *pvar_dset_devXxxSoft;
...
static const char * const deviceSupportNames[] = {
    ...
    "devLoSoftCallback", "devLsiSoft", "devLsiEnviron", "devpmVersion",
    "devLsoSoft", "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft",
    "devMbbiSoftRaw", "devMbbiSoftCallback", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "devMbboDirectSoft",
    "devMbboDirectSoftRaw", "devMbboDirectSoftCallback", "devPrintfSoft",
    ...
    "devSASoft", "devWfSoft", "devWfPDBDemo", "devXxxSoft"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devLiSoftCallback, pvar_dset_devLiGeneralTime,
    pvar_dset_devLoSoft, pvar_dset_devLoSoftCallback,
    pvar_dset_devLsiSoft, pvar_dset_devLsiEnviron, pvar_dset_devpmVersion,
    ...
    pvar_dset_devSASoft, pvar_dset_devWfSoft, pvar_dset_devWfPDBDemo,
...
int pm_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/pi/epics/iocs/pm";
...
/* pm_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pm_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pm_registerRecordDeviceDriver(*iocshPpdbbase));
}
